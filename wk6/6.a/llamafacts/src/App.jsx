...
function App() {
  const llamaFacts = [
    ...
    "A llama can project it's spit 15 or more feet. ", 
  ];
  ...
  return (
    <>
      ...
      <div>
      {llamaFacts}
      {llamaFacts ? <div>When a llama is angry at a fellow llama, they stick their tongues out to express their dislike.</div> : <div>A llama can project it's spit 15 or more feet. </div>}
      </div>
    </>
  )
}
